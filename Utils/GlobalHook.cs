//https://github.com/yhuse/SunnyUI/blob/073b782bcff610f4cc4a8f1e4b52a2efaf46389d/SunnyUI/Common/UHook.cs
using System;
...
namespace DeskApp.Utils
{
    ...
    public abstract class GlobalHook
    {
        ...
        public void Start()
        {
            if (!_isStarted && _hookType != 0)
            {
                ...
                _handleToHook = SetWindowsHookEx(_hookType, _hookCallback, IntPtr.Zero, 0);
        ...
        public void Stop()
        {
            if (_isStarted)
            {
                _ = UnhookWindowsHookEx(_handleToHook);
    ...
    public static class MouseSimulator
    {
        ...
        {
            get => new MousePoint(Cursor.Position);
        ...
        /// <summary>
        /// MenuFormShow a hidden current on currently application
        /// </summary>
        ...
        /// <summary>
        /// MenuFormHide mouse cursor only on current application's forms
        /// </summary>
